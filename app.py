...
def create_slide():
    ...
    try:
        ...
        app.logger.error(f"Failed to create slide: {str(e)}")
...
def download_presentation():
    ...
    try:
        ...
        app.logger.error(f"Failed to download presentation: {str(e)}")
